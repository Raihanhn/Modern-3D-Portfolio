    ...
    return (
      <div className="flex flex-col items-center justify-center text-center bg-[#1e293b] p-4 ml-[250px]">
        ...
        <p className="pl-10 text-xl tracking-wider font-inter">
          I am a front end web developer working on over 3+ years of experience.
          I love to take challenge and egger to deliver it within schedule.My
          expertise on Reactjs, Nextjs, Threejs Firebase, Typescript, Tailwind etc. I have well experienced to convert
